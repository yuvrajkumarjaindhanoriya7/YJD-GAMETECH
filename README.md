...
## 🛠️ File Explanations (Plain English)
...
1.  **Time-Sensitive Maps:** `mapname-morning.html` and `mapname-night.html`. name files as they described
...
2.  Include the `engine.js` script at the end of your HTML body.
